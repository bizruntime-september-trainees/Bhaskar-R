...
namespace GenericListMethods2
{
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            Console.WriteLine("First employee by index");
            ...
            Console.WriteLine(" list after inserting new employee in index 1");
            foreach (Employee e in listEmployees)
            {
                Console.WriteLine("ID = {0}, Name = {1}, Gender = {2}, Salary = {3}",
                        e.ID, e.Name, e.Gender, e.Salary);
            ...
            Employee empy = listEmployees.Find(employee => employee.Gender == "Male");
            Console.WriteLine("ID = {0}, Name = {1}, Gender = {2}, Salary = {3}",
                                empy.ID, empy.Name, empy.Gender, empy.Salary);
            Console.WriteLine("");
